...
d3.csv('demographic.csv').then(function(data) {
    ...
    const xScale = d3.scalePoint().range([0, width]).padding(0.5);  // Use point scale for categorical years
...
const legend = svg.append('g')
                  .attr('transform', `translate(${width - 150}, ${20})`);  // Position it in the top right corner
